...
parser = argparse.ArgumentParser(description='All results in the directory')
parser.add_argument('--dir', type=str, default='outputdirS-151673/',
                    help='outputdir')
